    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <?php
         ...
         require "php/db_connection.php"; // Include the file containing database connection details
         ...
         if($con) {
             ...
             if($result && mysqli_num_rows($result) > 0) {
                 ...
                 $pharmacy_name = isset($row['PHARMACY_NAME']) ? $row['PHARMACY_NAME'] : 'Undefined';
                 $address = isset($row['ADDRESS']) ? $row['ADDRESS'] : 'Undefined';
                 $email = isset($row['EMAIL']) ? $row['EMAIL'] : 'Undefined';
                 $contact_number = isset($row['CONTACT_NUMBER']) ? $row['CONTACT_NUMBER'] : 'Undefined';
                 $username = isset($row['USERNAME']) ? $row['USERNAME'] : 'Undefined';
             } else {
